...
model.train(data='E:\AI Ascending Software\AS AI Projects\building action recognition model\AI-PackageGuard\FineTuneYOLOToDetectPeopelWithParcels\configs\holding_parcel.yaml', 
            epochs=50, 
            imgsz=640, 
            batch=16,
