...
video_folder = r'E:\AI Ascending Software\AS AI Projects\building action recognition model\AI-PackageGuard\data\raw_videos'
output_folder = r'E:\AI Ascending Software\AS AI Projects\building action recognition model\AI-PackageGuard\data\frames'
