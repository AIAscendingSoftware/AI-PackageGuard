...
if __name__ == "__main__":
    source_folder = r"E:\AI Ascending Software\AS AI Projects\building action recognition model\AI-PackageGuard\FineTuneYOLOToDetectPeopelWithParcels\data\holdingparcelsframes"
    train_folder = r"E:\AI Ascending Software\AS AI Projects\building action recognition model\AI-PackageGuard\FineTuneYOLOToDetectPeopelWithParcels\data\custom_dataset\images\train"
    test_folder = r"E:\AI Ascending Software\AS AI Projects\building action recognition model\AI-PackageGuard\FineTuneYOLOToDetectPeopelWithParcels\data\custom_dataset\images\test"
    val_folder = r"E:\AI Ascending Software\AS AI Projects\building action recognition model\AI-PackageGuard\FineTuneYOLOToDetectPeopelWithParcels\data\custom_dataset\images\val"
