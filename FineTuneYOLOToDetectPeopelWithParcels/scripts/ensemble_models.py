...
if __name__ == '__main__':
    model_paths = [
        r'E:\AI Ascending Software\AS AI Projects\yolo\models\fine_tuned_model\best.pt',  # Fine-tuned model
        r'E:\AI Ascending Software\AS AI Projects\yolo\models\pre_trained_model\yolov8x.pt'  # Pre-trained model
    ]
    ...
    yolo_ensemble.run_inference(r'E:\AI Ascending Software\AS AI Projects\yolo\videos\WhatsApp Video 2024-08-30 at 21.13.02 (2).mp4')
